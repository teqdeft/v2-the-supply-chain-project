document.addEventListener('DOMContentLoaded', function () {
    ...
    if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
        ...
        // Story feature image
        document.querySelectorAll('.story-image-block').forEach(function (featureImg) {
            gsap.from(featureImg, {
                opacity: 0,
                y: 40,
                scale: 0.95,
                duration: 0.8,
        ...
        // Accordion items
        document.querySelectorAll('.benefits-accordions').forEach(function (accordion) {
            gsap.from(accordion.querySelectorAll('.accordion-item'), {
                opacity: 0,
                y: 30,
                duration: 0.6,
                stagger: 0.12,
        ...
        // Activity cards
        var actGrid = document.querySelector('.activities-grid');
        if (actGrid) {
